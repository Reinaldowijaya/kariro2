...
class Company(TimeStampedModel):
	...
	employee = models.CharField(max_length=10,blank=True,null=True)
...
class Job_Vacancy (TimeStampedModel):
	...
	education_level = models.CharField (choices = EDUCATION_CHOICES,max_length = 1,blank = True,null=True)
...
class Education(TimeStampedModel):
	...
	level = models.CharField (max_length=1,choices = EDUCATION_CHOICES)
	location = models.ForeignKey('Location')
	description = models.TextField()
	ipk = models.DecimalField(max_digits=2,decimal_places=1,blank = True,null=True)
